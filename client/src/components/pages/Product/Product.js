      ...
      <div className={styles.Product}>
        <div className={styles.product_wrapper}>
          <div className={styles.imgages_main}>
            <img src={`${imgPath}/${data.productId}/${data.imgMain}`} alt={data.title} />
          </div>
          <Container>
          ...
          <div className={styles.images_details}>
            <img src={`${imgPath}/${data.productId}/${data.imgDetails[0]}`} alt={data.title} />
            <img src={`${imgPath}/${data.productId}/${data.imgDetails[1]}`} alt={data.title} />
          </div>
        </div>
      </div>
    );
